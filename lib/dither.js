...
ditherFragShader = [
    ...
    '   float iN = mod(gl_FragCoord.x+shift.x, ditherN)/ditherN;',
    '   float jN = mod(gl_FragCoord.y+shift.y, ditherN)/ditherN;',
...
DitherMaterial = function ( parameters ) {
    ...
    this.ditherN = parameters.n || 4;
    this.shift = parameters.shift || Array.from(Array(2), function() { Math.random()*pow(2, ditherN);});
    this.ditherTex = makeDitherTexture(this.ditherN);
	...
	THREE.ShaderMaterial.call( this , {
        uniforms: {
            ...
            ditherN: {type: 'f', value: this.ditherN},
