...
// These 'specialised' mesh classes are used to make it more convenient to act
// on atoms, bonds etc.
function AtomMesh(radius = 1, color = 0xffffff, res = 32) {
    var geo = new THREE.SphereBufferGeometry(radius, res, res);
...
Object.defineProperty(AtomMesh.prototype, 'atom_scale', {
    get: function() {
        return this.scale.x;
    },
    set: function(s) {
...
function BondGroup(p0, p1, radius = 1, color0 = 0xff0000, color1 = 0x00ff00, res = 32) {
    p0 = p0.clone();
    p1 = p1.clone();
    ...
    var geo = new THREE.CylinderBufferGeometry(radius, radius, l / 2.0, res);
...
BondGroup.prototype = Object.create(THREE.Group.prototype);
Object.defineProperty(BondGroup.prototype, 'bond_radius', {
    get: function() {
        return this.children[0].geometry.parameters.radiusTop;
    }
});
Object.defineProperty(BondGroup.prototype, 'bond_radius_scale', {
    get: function() {
...
Object.defineProperty(BondGroup.prototype, 'bond_color_1', {
    get: function() {
...
Object.defineProperty(BondGroup.prototype, 'bond_color_2', {
    get: function() {
...
Renderer.prototype = {
    ...
    _addAtom: function(xyz, r, color, res) {
        ...
        var atom = new AtomMesh(r, color, res);
    ...
    _addBond: function(xyz0, xyz1, r, c0, c1, res) {
        ...
        var bond = new BondGroup(xyz0, xyz1, r, c0, c1, res);
    ...
    _addLattice: function(lattice_cart, lw) {
        ...
        for (var i = 0; i < 3; ++i) {
            ...
            dir.normalize();
            var arr = new THREE.ArrowHelper(dir, origin, l, [this._cell_x_color,
                this._cell_y_color,
                this._cell_z_color
            ][i]);
