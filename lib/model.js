...
AtomImage.prototype = {
    ...
    // Access and set graphical elements (hidden)
    get _mesh() {
    ...
    get _aura() {
        return this._model._graphics.sprites['#' + this._img_index];
    },
    set _aura(a) {
        this._model._graphics.sprites['#' + this._img_index] = a;
    },
    ...
    set highlighted(h) {
        ...
        if (aura) {
            aura.visible = h;
        } else if (h && this._model._renderer) {
            aura = this._model._renderer._addSprite(this._xyz,
                assets['circle.png'], this.radius*2.4, 0xffffff);
            this._aura = aura;
        }
    },
    /**
