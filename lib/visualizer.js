...
function CrystVis(element, width = 800, height = 600) {
    ...
    this._atom_click_events[this.LEFT_CLICK] = this._defaultAtomLeftClick.bind(this);
    this._atom_click_events[this.LEFT_CLICK+this.SHIFT_BUTTON] = this._defaultAtomShiftLeftClick.bind(this);
    this._atom_click_events[this.LEFT_CLICK+this.CTRL_BUTTON] = this._defaultAtomCtrlLeftClick.bind(this);
...
CrystVis.prototype = {
    ...
    onAtomClick(callback=null, modifiers=this.LEFT_CLICK) {

        // Check that event makes sense
        var lc = modifiers & this.LEFT_CLICK;
        var mc = modifiers & this.MIDDLE_CLICK;
        var rc = modifiers & this.RIGHT_CLICK;
    ...
    _handleAtomClick(alist, event) {
        ...
        modifiers = [this.LEFT_CLICK, this.MIDDLE_CLICK, this.RIGHT_CLICK][event.button];

        modifiers += event.shiftKey*this.SHIFT_BUTTON;
        modifiers += (event.ctrlKey || event.metaKey)*this.CTRL_BUTTON;
        modifiers += event.altKey*this.ALT_BUTTON;
...
Object.defineProperty(CrystVis.prototype, "LEFT_CLICK", { value: 1 });
Object.defineProperty(CrystVis.prototype, "MIDDLE_CLICK", { value: 2 });
Object.defineProperty(CrystVis.prototype, "RIGHT_CLICK", { value: 4 });
Object.defineProperty(CrystVis.prototype, "ALT_BUTTON", { value: 8});
Object.defineProperty(CrystVis.prototype, "CTRL_BUTTON", { value: 16});
Object.defineProperty(CrystVis.prototype, "CMD_BUTTON", { value: 16}); // Alias for MAC users
Object.defineProperty(CrystVis.prototype, "SHIFT_BUTTON", { value: 32});
