...
CrystVis.prototype = {
    ...
    _handleAtomClick(alist, event) {
        ...
        modifiers = [CrystVis.LEFT_CLICK, CrystVis.MIDDLE_CLICK, CrystVis.RIGHT_CLICK][event.button];
    ...
    loadModels(contents, format, prefix, scell = [1, 1, 1]) {
        ...
        switch (format) {
            ...
            case 'xyz':
                ...
                break;
            case 'magres':
                var a = this._loader.loadMagres(contents);
                structs = {};
                structs[prefix] = a;
                break;
            default:
        ...
        for (var n in structs) {
            ...
            this._models[nn] = new Model(s, scell);
            loaded.push(nn);
        }
...
Object.defineProperty(CrystVis, "LEFT_CLICK", { value: 1 });
Object.defineProperty(CrystVis, "MIDDLE_CLICK", { value: 2 });
Object.defineProperty(CrystVis, "RIGHT_CLICK", { value: 4 });
Object.defineProperty(CrystVis, "ALT_BUTTON", { value: 8});
Object.defineProperty(CrystVis, "CTRL_BUTTON", { value: 16});
Object.defineProperty(CrystVis, "CMD_BUTTON", { value: 16}); // Alias for MAC users
Object.defineProperty(CrystVis, "SHIFT_BUTTON", { value: 32});
